...
<https://pypi.org/pypi/setuptools#installation-instructions>`_ and then `install pip
...
.. list-table::
    ...
    * - ``sphinx_theme``
      ...
      - What Sphinx_ theme to use.
        ...
        <https://pypi.org/pypi/sphinx_py3doc_enhanced_theme>` for a responsive theme based on
...
Note:
    ...
    `twine <https://pypi.org/pypi/twine>`_ is a tool that you can use to securely upload your releases to PyPI.
...
.. _isort: https://pypi.org/pypi/isort
.. _bumpversion: https://pypi.org/pypi/bumpversion
